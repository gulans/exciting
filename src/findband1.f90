...
!write(*,*)"e0",e0
         ...
         write(*,'(a2,F7.3,a4,i2,a8,ES9.2E2,a8,ES9.2E2)')"e=",e0 ," nn=",nn, " p0(nr)=",p0 (nr)," p1(nr)=", p1(nr)
         u = p0 (nr)
         du = p1 (nr)
         eiup = e0
         eidn = e0
...
!write(*,*)"eiup",eiup
         ...
         write(*,'(a5,F7.3,a4,i2,a8,ES9.2E2,a8,ES9.2E2)')"e_up=",eiup ," nn=",nn, " p0(nr)=",p0 (nr)," p1(nr)=", p1(nr)
         uup = p0 (nr)
         duup = p1 (nr)
         utst = upold * uup
         dutst = dupold * duup
...
!write(*,*)"eidn",eidn
            ...
            write(*,'(a5,F7.3,a4,i2,a8,ES9.2E2,a8,ES9.2E2)')"e_do=",eidn ," nn=",nn, " p0(nr)=",p0 (nr)," p1(nr)=", p1(nr)
            udn = p0 (nr)
            dudn = p1 (nr)
            utst = dnold * udn
            dutst = ddnold * dudn
...
31       Continue
         ...
         Return
40       Continue
write(*,*)"findband1, viss ir slikti?"
write(*,*)"findband1 result e1=",e1,"e2=",e2,"e=",e0
write(*,*)"e_do=",eidn, "e_up=",eiup
!        Print the warning
