...
!
!
Subroutine rschroddme2 (is,ia,m, l, k, e, nr, r, vr, nn, p0, p1, q0, q1)
use mod_timing
use modinput
      ...
      If (k .Eq. 0) Then
         if ((relativity.eq."zora").or.(relativity.eq."none")) then
           ...
           If (m .Eq. 0) Then
             ...
             call getu(m,is,ia,nr,vr,l,e,p0p,p0,p1)

             !Call rschrodint (m, l, e, nr, r, vr, nn, rmfactor, p0p, p0, p1, q0, q1)
           Else
             Do im = 0, m
             call getu(im,is,ia,nr,vr,l,e,p0p,p0,p1)
